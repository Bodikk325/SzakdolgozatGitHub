...
export class FourthComponent {
 ...
 constructor(private serialService : SerialService, private microBitService : MicroBitService, private router : Router, private fieldService : FieldService) {
 ...
 Initalize()
 {
  ...
  ngAfterViewInit() {
    this.Initalize()
    this.showVideo("https://www.youtube.com/embed/qNVBtCVC-H8")
  }
