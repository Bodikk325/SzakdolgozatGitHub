...
export class ThirdComponent {
   ...
   *
   */
  constructor(private serialService : SerialService,private router : Router, private fieldService : FieldService, private microBitService : MicroBitService) {
  ...
  ngAfterViewInit() {
    ...
    this.showVideo("https://www.youtube.com/embed/AnV9XXs0W50")
