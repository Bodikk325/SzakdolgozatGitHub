...
export class SecondComponent {
   ...
   *
   */
  constructor(private serialSerivce : SerialService,private router : Router, private fieldService : FieldService, private httpClient : HttpClient, private numberServices : NumberService, private microBitService : MicroBitService) {
...
this.Initialize()
  ...
  runCode() {
    ...
    this.serialSerivce.sendCode(`reset(); 
        ${code}
      `);
